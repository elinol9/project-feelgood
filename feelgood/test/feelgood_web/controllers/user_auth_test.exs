defmodule FeelgoodWeb.UserAuthTest do
  use FeelgoodWeb.ConnCase, async: true

  alias Feelgood.Accounts
  alias FeelgoodWeb.UserAuth
  import Feelgood.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FeelgoodWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FeelgoodWeb.Endpoint.subscribe(live_socket_id)
